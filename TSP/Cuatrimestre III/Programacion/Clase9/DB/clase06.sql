...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2018 a las 03:03:37
...
INSERT INTO `clientes` (`nombre`, `nacionalidad`, `sexo`, `edad`, `id`) VALUES
('Juan', 'Argentino', 'm', 25, 1),
('Juana', 'Argentino', 'f', 25, 2),
('Mariano', 'Argentino', 'm', 22, 3),
('Mauricio', 'Argentino', 'm', 26, 4),
('Camilo', 'Colombiana', 'm', 26, 5),
('Camila', 'Colombiana', 'f', 26, 6);
